...
public class ExcelGenerator {
    ...
    public static byte[] generateLogExcel(List<LogExcelResponse> logs) throws IOException {
    ...
    private static void createBodyRows(Sheet sheet, List<LogExcelResponse> logs, CellStyle style) {
        int rowIdx = 2;
        int no = 1;
        ...
        for (LogExcelResponse log : logs) {
            ...
            createCell(row, col++, log.visitDate(), style);
