...
public class QLog extends EntityPathBase<Log> {
    ...
    public final com.example.gujeuck_server.domain.user.entity.QUser user;
    ...
    public QLog(Class<? extends Log> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.gujeuck_server.domain.user.entity.QUser(forProperty("user")) : null;
    }
